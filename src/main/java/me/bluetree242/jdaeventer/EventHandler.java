...
/**
 * This class is event handler, you can add event handlers to {@link JDAEventer#addEventHandler(EventHandler)} and it will call the {@link EventHandler#onEvent(GenericEvent)} if the events match
