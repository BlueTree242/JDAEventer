...
/**
 * This class is event handler, you can add event handlers to {@link JDAEventer#addEventHandler(EventHandler)} and it will call the {@link EventHandler#getEvent()} if the events match
